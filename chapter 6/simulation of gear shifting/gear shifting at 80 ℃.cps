...
<!-- generated with COPASI 4.16 (Build 104) (http://www.copasi.org) at 2022-09-13 09:21:13 UTC -->
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_39">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_40" name="GAPDH/(GAPDH +PGK)" simulationType="assignment">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_40">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_41" name="GAPN/(GAPDH +PGK)" simulationType="assignment">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_42">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2022-03-26T18:29:31Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
  </rdf:Description>
</rdf:RDF>
  ...
  <rdf:Description rdf:about="#Reaction_0">
    ...
    <CopasiMT:is>
      <rdf:Bag>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5024" name="VmPGK" value="110"/>
  ...
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5017" name="VmPGAM" value="75"/>
  ...
  <rdf:Description rdf:about="#Reaction_2">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5013" name="VmPYK" value="76"/>
  ...
  <rdf:Description rdf:about="#Reaction_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5007" name="VmENO" value="27.8"/>
  ...
  <rdf:Description rdf:about="#Reaction_4">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5003" name="VmGAPN" value="36"/>
  ...
  <rdf:Description rdf:about="#Reaction_5">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5000" name="VmGAPDH" value="87"/>
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Values[VmENO]" value="27.8" type="ModelValue" simulationType="fixed"/>
          ...
          <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Values[GAPDH/(GAPDH +PGK)]" value="NaN" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Values[GAPN/(GAPDH +PGK)]" value="NaN" type="ModelValue" simulationType="assignment"/>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=Yanfei,Vector=Reactions[ENO]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Reactions[ENO],ParameterGroup=Parameters,Parameter=VmENO" value="27.8" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
