...
<!-- generated with COPASI 4.16 (Build 104) (http://www.copasi.org) at 2022-09-13 18:23:19 UTC -->
...
<rdf:RDF xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Function_13">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2016-12-21T16:13:38Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_36">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_37" name="ATP/ADP ratio" simulationType="assignment">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_37">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2016-12-22T12:35:02Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
  </rdf:Description>
</rdf:RDF>
  ...
  <rdf:Description rdf:about="#Reaction_5">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5000" name="VmGAPDH" value="430"/>
  ...
  <rdf:Description rdf:about="#Reaction_6">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4993" name="KdBPG" value="105.824"/>
        </ListOfConstants>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_7">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2016-12-21T11:26:13Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
  </rdf:Description>
</rdf:RDF>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4992" name="k1" value="3.5833"/>
        </ListOfConstants>
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Compartments[default_compartment],Vector=Metabolites[GAP]" value="9.033212685000011e+020" type="Species" simulationType="fixed"/>
          ...
          <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Compartments[default_compartment],Vector=Metabolites[Phosphate]" value="6.022141790000004e+022" type="Species" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Compartments[default_compartment],Vector=Metabolites[NADP]" value="9.575205446100002e+020" type="Species" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Compartments[default_compartment],Vector=Metabolites[NADPH]" value="6.022141790000001e+019" type="Species" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Values[VmGAPDHf]" value="430" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Values[kPK]" value="0" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Values[kdBPG]" value="105.824" type="ModelValue" simulationType="fixed"/>
          ...
          <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Values[KATPase]" value="3.5833" type="ModelValue" simulationType="fixed"/>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=Yanfei,Vector=Reactions[GAPDH]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Reactions[GAPDH],ParameterGroup=Parameters,Parameter=VmGAPDH" value="430" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=Yanfei,Vector=Reactions[Spontenous degradation ]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Reactions[Spontenous degradation ],ParameterGroup=Parameters,Parameter=KdBPG" value="105.824" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=Yanfei,Vector=Reactions[Atpase]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Reactions[Atpase],ParameterGroup=Parameters,Parameter=k1" value="3.5833" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
    ...
    <InitialState type="initialState">
      0 0 1.51757973108e+021 0 0 0 7.949227162800002e+020 NaN 1.909090909090909 9.033212685000011e+020 1.11409623115e+021 6.022141790000004e+022 9.575205446100002e+020 6.022141790000001e+019 1 0.089 3.1091 1.14174 0.204 0.09445000000000001 0.374 9.303000000000001 0.567 0.008200000000000001 408.523 30 430 0 105.824 1.56416 6.7 0.04 0.5 23.9 70 0.53 1.5 0.14 0 0.02 0.09 1.2 0.08 93 0.19 21 6500 3.5833 0.000185 3793 108.32 
    </InitialState>
  </Model>
  <ListOfTasks>
      ...
      <Problem>
        ...
        <ParameterGroup name="ScanItems">
          ...
          <ParameterGroup name="ScanItem">
            ...
            <Parameter name="Minimum" type="float" value="8.5"/>
  ...
  <ListOfPlots>
    <PlotSpecification name="plot_1" type="Plot2D" active="1">
      ...
      <ListOfPlotItems>
        <PlotItem name="Values[ATP consumption flux/ Pyruvate flux ]|Values[KATPase].InitialValue" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Yanfei,Vector=Values[KATPase],Reference=InitialValue"/>
            <ChannelSpec cn="CN=Root,Model=Yanfei,Vector=Values[ATP consumption flux/ Pyruvate flux ],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="Values[ATP/ADP ratio]|Values[KATPase].InitialValue" type="Curve2D">
          <Parameter name="Color" type="string" value="auto"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
