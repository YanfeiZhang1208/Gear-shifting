...
<!-- generated with COPASI 4.16 (Build 104) (http://www.copasi.org) at 2022-09-12 23:43:47 UTC -->
  ...
  <rdf:Description rdf:about="#Reaction_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5007" name="VmENO" value="20.5"/>
  ...
  <rdf:Description rdf:about="#Reaction_6">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4993" name="KdBPG" value="10.5824"/>
        </ListOfConstants>
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Values[kdBPG]" value="10.5824" type="ModelValue" simulationType="fixed"/>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=Yanfei,Vector=Reactions[Spontenous degradation ]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Reactions[Spontenous degradation ],ParameterGroup=Parameters,Parameter=KdBPG" value="10.5824" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
