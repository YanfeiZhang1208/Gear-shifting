...
<!-- generated with COPASI 4.23 (Build 184) (http://www.copasi.org) at 2021-07-18 09:01:24 UTC -->
  ...
  <rdf:Description rdf:about="#Function_41">
    <dcterms:created>
      ...
      <ListOfParameterDescriptions>
        ...
        <ParameterDescription key="FunctionParameter_270" name="KmPGMAP3G" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_269" name="P3G" order="2" role="substrate"/>
        <ParameterDescription key="FunctionParameter_268" name="P2G" order="3" role="product"/>
        <ParameterDescription key="FunctionParameter_267" name="KeqPGMA" order="4" role="constant"/>
        <ParameterDescription key="FunctionParameter_266" name="KmPGMAP2G" order="5" role="constant"/>
      </ListOfParameterDescriptions>
    </Function>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_25">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_26" name="KmPGMA3PG" simulationType="fixed" addNoise="false">
      </ModelValue>
      <ModelValue key="ModelValue_27" name="KmPGMA2PG" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_27">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_28" name="VmPGMA" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_28">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_29" name="KeqPGMA" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:RDF xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_0">
    ...
    <CopasiMT:is>
      ...
      <Reaction key="Reaction_1" name="PGMA" reversible="true" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4997" name="VmPGMA" value="75"/>
          <Constant key="Parameter_4996" name="KmPGMAP3G" value="1.2"/>
          <Constant key="Parameter_4995" name="KeqPGMA" value="0.19"/>
          <Constant key="Parameter_4994" name="KmPGMAP2G" value="0.08"/>
        </ListOfConstants>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_6">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Values[KmPGMA2PG]" value="0.080000000000000002" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Values[VmPGMA]" value="75" type="ModelValue" simulationType="fixed"/>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=Yanfei,Vector=Reactions[PGMA]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Reactions[PGMA],ParameterGroup=Parameters,Parameter=VmPGMA" value="75" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
            ...
            <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Reactions[PGMA],ParameterGroup=Parameters,Parameter=KmPGMAP2G" value="0.080000000000000002" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
    ...
    <InitialState type="initialState">
      0 0 0 0 0 7.9492271628000022e+20 1.51757973108e+21 9.0332126850000028e+19 1.11409623115e+21 6.0221417900000003e+21 7.2265701480000022e+20 2.3486352980999999e+20 1 0.088999999999999996 3.1091000000000002 1.14174 0.20399999999999999 0.094450000000000006 0.374 9.3030000000000008 0.56699999999999995 0.0082000000000000007 408.52300000000002 110 87 0 1.0582400000000001 1.56416 6.7000000000000002 0.040000000000000001 0.5 20.5 76 0.53000000000000003 1.5 0.14000000000000001 36 0.02 0.089999999999999997 1.2 0.080000000000000002 75 0.19 21 6500 6.5833000000000004 0.000185 3793 108.31999999999999 0 
    </InitialState>
  </Model>
  <ListOfTasks>
