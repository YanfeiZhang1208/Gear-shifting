...
<!-- generated with COPASI 4.23 (Build 184) (http://www.copasi.org) at 2022-03-26 20:06:27 UTC -->
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_7">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Values[(2GAPDH+GAPN)/PYK]" value="-229.06287334267719" type="ModelValue" simulationType="assignment"/>
        </ModelParameterGroup>
    ...
    <InitialState type="initialState">
      0 0 1.51757973108e+21 0 0 0 7.9492271628000022e+20 -127.05173100535804 1.9090909090909087 29.729346948909146 0.0060809723714658117 0.99391902762853412 -229.06287334267719 9.0332126850000028e+19 1.11409623115e+21 6.0221417900000003e+21 7.2265701480000022e+20 2.3486352980999999e+20 1 0.088999999999999996 3.1091000000000002 1.14174 0.20399999999999999 0.094450000000000006 0.374 9.3030000000000008 0.56699999999999995 0.0082000000000000007 408.52300000000002 110 87 0 1.0582400000000001 1.56416 6.7000000000000002 0.040000000000000001 0.5 20.5 76 0.53000000000000003 1.5 0.14000000000000001 36 0.02 0.089999999999999997 1.2 0.080000000000000002 75 0.19 21 6500 6.5833000000000004 0.000185 3793 108.31999999999999 0 
    </InitialState>
  </Model>
  <ListOfTasks>
  ...
  <ListOfPlots>
    ...
    <PlotSpecification name="plot_2" type="Plot2D" active="1" taskTypes="">
      ...
      <Parameter name="log Y" type="bool" value="0"/>
      <ListOfPlotItems>
        <PlotItem name="Values[(2GAPDH+GAPN)/PYK]|(Atpase).ParticleFlux" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line width" type="unsignedFloat" value="1"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="0"/>
          ...
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Yanfei,Vector=Reactions[Atpase],Reference=ParticleFlux"/>
            <ChannelSpec cn="CN=Root,Model=Yanfei,Vector=Values[(2GAPDH+GAPN)/PYK],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
