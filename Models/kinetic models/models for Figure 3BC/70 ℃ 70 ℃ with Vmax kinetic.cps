...
<!-- generated with COPASI 4.23 (Build 184) (http://www.copasi.org) at 2022-03-26 20:15:30 UTC -->
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_41">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_42" name="(2GAPDH+GAPN)/PYK" simulationType="assignment" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  ...
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4997" name="VmPGAM" value="93"/>
  ...
  <rdf:Description rdf:about="#Reaction_4">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4983" name="VmGAPN" value="20"/>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_7">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Values[VmGAPN]" value="20" type="ModelValue" simulationType="fixed"/>
          ...
          <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Values[ATP consumption flux/ Pyruvate flux]" value="-137.94187937724587" type="ModelValue" simulationType="assignment"/>
          ...
          <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Values[GAPDH + GAPN flux]" value="16.505221357061831" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Values[GAPDH/(GAPDH +PGK)]" value="0.0054136010707293066" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Values[GAPN/(GAPDH +PGK)]" value="0.9945863989292707" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Values[(2GAPDH+GAPN)/PYK]" value="-137.98061007002525" type="ModelValue" simulationType="assignment"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=Yanfei,Vector=Reactions[GAPN]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Yanfei,Vector=Reactions[GAPN],ParameterGroup=Parameters,Parameter=VmGAPN" value="20" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
    ...
    <InitialState type="initialState">
      0 0 1.51757973108e+21 0 0 0 7.9492271628000022e+20 -137.94187937724587 1.9090909090909087 16.505221357061831 0.0054136010707293066 0.9945863989292707 -137.98061007002525 9.0332126850000028e+19 1.11409623115e+21 6.0221417900000003e+21 7.2265701480000022e+20 2.3486352980999999e+20 1 0.088999999999999996 3.1091000000000002 1.14174 0.20399999999999999 0.094450000000000006 0.374 9.3030000000000008 0.56699999999999995 0.0082000000000000007 408.52300000000002 30 43 0 1.0582400000000001 1.56416 6.7000000000000002 0.040000000000000001 0.5 20.5 70 0.53000000000000003 1.5 0.14000000000000001 20 0.02 0.089999999999999997 1.2 0.080000000000000002 93 0.19 21 6500 6.5833000000000004 0.000185 3793 108.31999999999999 0 
    </InitialState>
  </Model>
  <ListOfTasks>
      ...
      <Problem>
        ...
        <ParameterGroup name="ScanItems">
          <ParameterGroup name="ScanItem">
            <Parameter name="Number of steps" type="unsignedInteger" value="120"/>
